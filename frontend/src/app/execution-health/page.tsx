...
import {
  Loader2, AlertTriangle, HeartPulse, Zap, CheckCircle2, XCircle,
  ...
  return (
    <div className="space-y-8">
      ...
      <section>
        ...
        <div className="g4">
          <MetricDisplay label="Orders Submitted" value={stats.orders_today?.submitted ?? 0} icon={Zap} />
          <MetricDisplay label="Orders Filled" value={stats.orders_today?.filled ?? 0} icon={CheckCircle2} trend="up" />
          <MetricDisplay label="Orders Rejected" value={stats.orders_today?.rejected ?? 0} icon={XCircle} />
          <MetricDisplay label="Orders Cancelled" value={stats.orders_today?.cancelled ?? 0} icon={Activity} />
        </div>
      </section>
      ...
      <section>
        ...
        <div className="g4">
          <MetricDisplay label="Risk Rejections" value={stats.risk_stats?.risk_rejections ?? 0} icon={XCircle} />
          <MetricDisplay label="AI Rejections" value={stats.risk_stats?.ai_rejections ?? 0} icon={AlertTriangle} />
          <MetricDisplay label="Leverage Rejections" value={stats.risk_stats?.leverage_rejections ?? 0} icon={XCircle} />
          <MetricDisplay label="Kill Switch Rejections" value={stats.risk_stats?.kill_switch_rejections ?? 0} icon={HeartPulse} />
        </div>
      </section>
      ...
      <section>
        ...
        <div className="g4">
          ...
          <MetricDisplay label="Success Rate (1H)" value={`${stats.success_rate_pct}%`} icon={HeartPulse} trend={stats.success_rate_pct > 90 ? 'up' : 'down'} />
        </div>
      </section>
